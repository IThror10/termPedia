...
class QueryHandlerVisitorTest {
    ...
    void visitFindTermQuery() throws Exception {
        ...
        when(searcher.getTermsByName(any(IByNameGetSettings.class))).thenReturn(QueryTestObjectsFactory.termsVector());
    ...
    void visitFindTagByNameQuery() throws Exception {
        ...
        when(searcher.getTagsByName(any(IByNameGetSettings.class))).thenReturn(QueryTestObjectsFactory.tagsVector());
    ...
    void visitFindTagByTermNameQuery() throws Exception {
        ...
        TagsSearcher searcher = Mockito.mock(TagsSearcher.class);
        doReturn(searcher).when(mockFactory).createTagSearcher();
        when(searcher.getTagsByTerm(any(IRatedGetSettings.class))).thenReturn(QueryTestObjectsFactory.ratedTagsVector());
    ...
    void visitFindAuthorByNameQuery() throws Exception {
        ...
        when(searcher.getAuthorByName(any(IByNameGetSettings.class))).thenReturn(QueryTestObjectsFactory.authorsVector());
    ...
    void visitFindLitTypesByNameQuery() throws Exception {
        ...
        when(searcher.getLitTypesByName(any(IByNameGetSettings.class))).thenReturn(QueryTestObjectsFactory.litTypesVector());
    ...
    void visitSearchBookByNameQuery() throws Exception {
        ...
        when(searcher.searchByBookName(any(BaseSearchBookByBookNameQuery.class)))
                .thenReturn(QueryTestObjectsFactory.tagBooks());
        ...
        //Assert
        assertAll(
                () -> assertEquals(QueryTestObjectsFactory.tagBook(null).toString(), books.get(0).toString()),
    ...
    void visitSearchBookByAuthorQuery() throws Exception {
        ...
        when(searcher.searchByAuthorName(any(BaseSearchBookByAuthorNameQuery.class)))
                .thenReturn(QueryTestObjectsFactory.commonBooks());
        ...
        assertAll(
                () -> assertEquals(1, books.size()),
                () -> assertEquals(QueryTestObjectsFactory.commonBook(null).toString(), books.get(0).toString())
        );
    }
    ...
    void visitSearchBookByTermQuery() throws Exception {
        ...
        when(searcher.searchByTermName(any(BaseSearchBookByTermQuery.class)))
                .thenReturn(QueryTestObjectsFactory.ratedBooks());
        ...
        assertAll(
                () -> assertEquals(1, books.size()),
                () -> assertEquals(QueryTestObjectsFactory.ratedBook(null).toString(), books.get(0).toString())
        );
    }
}